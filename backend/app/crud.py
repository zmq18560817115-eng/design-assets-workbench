...
def serialize_layout_pattern(pattern: models.LayoutPattern) -> dict:
    ...
    return {
        "id": pattern.id,
        "name": pattern.name,
        "pattern_code": pattern.pattern_code or "",
        ...
        "layout_signature": pattern.layout_signature or "",
        ...
        "module_structure_json": _json_list(pattern.module_structure_json or pattern.modules_json),
        "average_positions_json": _json_list(pattern.average_positions_json or pattern.modules_json),
        "required_modules_json": _json_list(pattern.required_modules_json),
        "optional_modules_json": _json_list(pattern.optional_modules_json),
        "suitable_scenes_json": _json_list(pattern.suitable_scenes_json),
        "unsuitable_scenes_json": _json_list(pattern.unsuitable_scenes_json),
        "evidence_case_ids_json": _json_list(pattern.evidence_case_ids_json or pattern.source_case_ids),
        "evidence_blueprint_ids_json": _json_list(pattern.evidence_blueprint_ids_json or pattern.source_blueprint_ids),
        "evidence_count": pattern.evidence_count or len(_json_list(pattern.source_blueprint_ids)),
        "confidence_level": pattern.confidence_level or "candidate",
        "discovery_method": pattern.discovery_method or "",
        ...
        "product_category_tags_json": _json_list(pattern.product_category_tags_json),
        "content_purpose_tags_json": _json_list(pattern.content_purpose_tags_json),
        "campaign_stage_tags_json": _json_list(pattern.campaign_stage_tags_json),
        ...
        "source_candidate_ids_json": _json_list(pattern.source_candidate_ids_json),
        ...
        "reviewer": pattern.reviewer or pattern.editor or "",
