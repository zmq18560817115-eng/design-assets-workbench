...
export default function RequirementDetailPage() {
  ...
  return <div>
    <div className="mb-6 flex items-end justify-between gap-4"><div><h1 className="text-3xl font-bold">{item.title}</h1><p className="mt-2 text-sm text-gray-500">状态：{item.status} · 需求确认只锁定结构化条件，不生成排版方向。</p></div>
